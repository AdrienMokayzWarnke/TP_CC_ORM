...
public final class ReflectionUtil {
    ...
    public static Stream<Field> getFielsWithoutIdOrTranscient(Class entityClass) {
        return  getFields(entityClass, f ->
                !(getAnnotationForField(f, Transient.class).isPresent()
                        ||getAnnotationForField(f,Id.class).isPresent()));
    }
    public static <T> Stream<Field> getFieldsForColums(T entity){
        return getFields(entity.getClass(), f->
                !(getAnnotationForField(f, Transient.class).isPresent()||getAnnotationForField(f,Id.class).isPresent())
                        &&getValue(f,entity).isPresent()
        );
    }
